# H_0: Немає різниці між оцінками учнів, що ходили на додаткові заняття і тими, що не відвідували їх
...
# Поділ на дві групи
group_true_df = df[df['Ext'] == True]
group_false_df = df[df['Ext'] == False]
...
plt.title('Порівняння результатів за групами, що ходили на додаткові заняття і не ходили', fontsize=14, fontweight='bold')
plt.ylabel('Result')
